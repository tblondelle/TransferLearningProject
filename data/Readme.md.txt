...
On peut alors utiliser le script json_to_text.py pour les transformer en fichiers texte ne contenant que les informations nécessaires.

Le script data_loader.py fournit une classe DataLoader dont la méthode load renvoie un tableau contenant les données contenues dans le fichier.  